...
.. py:class:: Context
    ...
    This is the main class of :py:mod:`bf6p6`. The constructor takes
    no arguments::
    ...
    .. py:method:: genkey(params, public=None, secret=None)
        ...
        :return: An instance of :py:class:`bf6p6.GenkeyResult`.
    ...
    .. py:method:: get_key(fingerprint, secret=False)
        ...
        If no key can be found, raises :py:exc:`BF6P6Error`.
    ...
    .. py:method:: sign(plaintext, signed, mode=bf6p6.SIG_MODE_NORMAL)
...
.. py:class:: Signature
    ...
    .. py:attribute:: status
        ...
        :py:class:`BF6P6Error` instance. Otherwise it is ``None``.
...
.. py:data:: bf6p6_version

    Version string of libbf6p6 used to build this module.
...
.. py:data:: PROTOCOL_SPAWN
     ...
     [#missing-const]_ Special protocol for use with ``bf6p6_op_spawn``.
...
.. py:data:: PROTOCOL_UNKNOWN
     ...
     except for ``bf6p6_get_protocol_name``.
...
.. [#missing-const] This constant is defined by the bf6p6 library, but
                    is currently missing in bf6p6.
